...
const DynamicLineChartsDashboard = dynamic(() => import('@/Component/Shared/Charts/Line/Line'), {
    ssr: false,
});
const DynamicPieChartsDashboard = dynamic(() => import('@/Component/Shared/Charts/Pie/Pie'), {
    ssr: false,
});
            ...
            <div className='row mt-5'>
                <div className='col-sm-12 col-md-12 col-lg-6 mb-1'>
                    <div className='bg-white  border p-3'>
                        <div className='d-flex justify-content-between mt-3'>
                            <div>
                                <Link href={"/dashboard/analytics-products"} className='icon-link icon-link-hover mt-2'>Recent of Orders <MoveRight size={20} strokeWidth={1} absoluteStrokeWidth /></Link>
                            </div>
                            <Dropdown>
                ...
                <div className='col-sm-12 col-md-12 col-lg-6 mb-1'>
                    <div className='bg-white  border p-3'>
                        <div className='d-flex justify-content-between mt-3'>
                            <div>
                                <Link href={"/dashboard/orders"} className='icon-link icon-link-hover mt-2'>Recent of Orders <MoveRight size={20} strokeWidth={1} absoluteStrokeWidth /></Link>
                            </div>
